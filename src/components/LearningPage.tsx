...
//       video: "src/assets/IntroductionToVector.mp4",
//       assessment: {
//         multiple_choice: {
...
//                 <video
//                   src={
//                     currentSlide.video || "src/assets/IntroductionToVector.mp4"
//                   }
//                   autoPlay
//                   muted
//                   loop
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen bg-black p-4 md:p-8">
      ...
      <AnimatePresence mode="wait" custom={direction}>
        ...
        >
          {/* Box 1: Video - Now larger and takes up 2/3 of the first row */}
